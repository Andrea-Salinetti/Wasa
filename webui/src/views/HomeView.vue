...
<template>
	<div>
	  ...
	  <div v-if="!logged" style="text-align: center; background-color: rgb(208, 219, 252); border-radius:10px; padding: 20px;">
	  <p class="h3">Register or log-in</p>
	  <img src="/wasa-photo-logo.png" style="max-width: 20vw; height: auto; border-radius: 10px;">
		<div style="border: solid; border-color: grey; border-radius: 10px; padding: 20px; margin-right: 20vw; margin-left: 20vw;">
	  ...
	  <div v-if="logged && !stream.length" style="text-align: center;"> 
		<p class="positive-banner" style="font-size: 30px; font-weight: bold; margin-top: 10vh;" >Welcome to Wasa-Photo!</p>
